...
//edit
const selectElement = document.getElementById('verif');
const gatheringButton = document.getElementById('gatheringButton');
...
async function saveModel(){
  await model.save('http://127.0.0.1:8000/save-model');
}
